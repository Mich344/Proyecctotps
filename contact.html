...
<html lang="es">
<head>
<title>SportsWearLine - Contáctanos</title>
<!-- for-mobile-apps -->
	...
	<div class="contact">
		<div class="container">
			<div class="title-info wow fadeInUp animated" data-wow-delay=".5s">
				<h3 class="title"> <span id="signo">¿</span>Cómo <span> contáctarnos<span id="signo">?</span></span></h3>
				<p>Contáctanos aquí</p>
			</div>
			<iframe width="560" height="315" src="https://www.youtube.com/embed/N492wxbe2rM?autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>	
	</div>
			...
			<div class="address-row">
				...
				<div class="col-md-6 address-right">
					...
					<div class="address-info wow fadeInRight animated" data-wow-delay=".6s">
						<h4>EMAIL</h4>
						<p><a href="sportwearline@gmail.com"> sportwearline@gmail.com</a></p>
					</div>
				</div>
			</div>	
		</div>	
...
">
		<div class="container">
			<div class="footer-info">
				<div class="col-md-4 footer-grids wow fadeInUp animated" data-wow-delay=".5s">
					...
					<p style = "color: white"><strong>SPORTSWEARLINE Vístete bien hoy tienes una cita con el deporte ¡Marca tu estilo! </strong></p>
				</div>
	...
	<script type="text/javascript">
		var sound = new Audio();
		sound.src = "../images/Audio/Contactanos.mp3"
	</script>
	<!--//search jQuery-->
