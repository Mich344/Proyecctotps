		...
		<div class="header-two navbar navbar-default"><!--header-two-->
			<div class="container">
				<div class="nav navbar-nav header-two-left">
					<ul>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"><a href="https://wa.link/hzuccw" target="_blank" style="border-radius:5%" ></i><strong>Escríbenos por WhatsApp</strong></a></li>
						<br>
				...
				<div class="nav navbar-nav logo wow zoomIn animated" data-wow-delay=".7s">
					<h1><a href="index.html" style = "color: #B2051F">SPORTS<b>WEARLINE</b><span class="tag"> Vístete bien, hoy tienes una cita con el deporte ¡Marca tú estilo!</span> </a></h1>
				</div>
									...
									<div class="row">
										<div class="col-sm-4 menu-grids menulist1">
											...
											<ul class="multi-column-dropdown ">
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Camisas manga larga</b></a></li>
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Camisas manga corta</b></a></li>
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Camisas sin manga</b></a></li>
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Camisillas</b></a></li>
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Camisas polo</b></a></li>
											</ul>
										</div>																		
										<div class="col-sm-2 menu-grids">
											<h4>Pantalones</h4>
											<ul class="multi-column-dropdown">
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Pantalones</b></a></li>
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Sudaderas</b></a></li>
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Joggers</b></a></li>
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Licras</b></a></li>
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Faldas</b></a></li>
											</ul>
										</div>
										<div class="col-sm-3 menu-grids">
											<ul class="multi-column-dropdown">
												<h4>Accesorios Deportivos</h4>
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Gorros</b></a></li>
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Guantes</b></a></li>
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Gafas de sol</b></a></li>
											</ul>
										</div>
								...
								<ul class="dropdown-menu multi-column menu-two multi-column3">
									<div class="row">
										<div class="col-sm-4 menu-grids">
											<ul class="multi-column-dropdown">
												<h4>Zapatillas</h4>
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Zapatillas para correr</b></a></li>
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Zapatillas senderismo</b></a></li>
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Zapatillas Pronadoras</b></a></li>
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Zapatillas Cross Training</b></a></li>
									...
									<div class="row">
										<div class="col-sm-4 menu-grids">
											<ul class="multi-column-dropdown">
												...
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Cuerdas</b></a></li>
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Mancuernas</b></a></li>
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Botellas</b></a></li>
												<li><a class="list" href="products.html" style = "color:linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%);"><b>Guantes</b></a></li>
											</ul>
										</div>
										<div class="col-sm-8 menu-grids">
						...
						<ul class="slides">
							<li>
								...
								<div class="col-md-7 trend-right">
									<h4>DESCUENTOS EN ACCESORIOS DEPORTIVOS</span></h4>
									<h5> 20% DE DESCUENTO</h5>
									<p>Compra online de cascos, guantes e hidratación deportiva a precios bajos con envío a todo Colombia, Somos la mejor opción a la hora de comprar!</p>
								</div>
								<div class="clearfix"></div>
							</li>
							<li>
								...
								<div class="col-md-7 trend-right">
									...
									<h5>20% DE DESCUENTO</h5>
									<p>Encuentra el estilo en camisetas deportivas que estás buscando y en las mejores marcas como ADIDAS, NIKE , PUMA , DIESEL y muchas más.</p>
								</div>
								<div class="clearfix"></div>
							</li>
							<li>
								...
								<div class="col-md-7 trend-right">
									<h4>DESCUENTOS EN CONJUNTOS FEMENINOS</span></h4>
									<h5>20% DE DESCUENTO</h5>
									<p>Compra online Conjuntos deportivos mujer con pantalones deportivos, crop top y más. Ahorra tiempo y dinero haciendo tus compras en Tienda Moderna.</p>
								</div>
								<div class="clearfix"></div>
							</li>
							<li>
								...
								<div class="col-md-7 trend-right">
									<h4>DESCUENTOS EN ZAPATOS DEPORTIVOS <span>¡PARA TI!</span></h4>
									<h5>20% DE DESCUENTO </h5>
									<p>¡Zapatillas deportivas tanto de hombre como de mujer con un descuento del 20%! Modelos de marcas como Adidas y Nike con unas rebajas inimaginables que harán que tengas el estilo que mereces. Comodidad y calidad a un precio más bajo imposible.</p>
								</div>
								<div class="clearfix"></div>
							</li>
						</ul>
		...
		<div class="container">
			<div class="footer-info">
				...
				<div class="col-md-4 footer-grids wow fadeInUp animated" data-wow-delay=".9s">
					<h2 style = "color: #B2051F";><strong>Suscribirse</strong></h2>
					<p  style = "color: white;">Registrate para más información <br> Acerca de nuestra compañía </p>
					<form>
						<input type="text" placeholder="Ingresa tú correo" required="Error">
