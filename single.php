		...
		<div class="container">
			<div class="single-info">		
				...
				<div class="col-md-6 single-top-left simpleCart_shelfItem wow fadeInRight animated" data-wow-delay=".5s">
					<h3>Buso capucha estilo deportivo</h3>
					...
					<p>En este preciso momento, personas de todo el mundo están pasando su día y haciendo lo que tienen que hacer luciendo el logo adidas Badge of Sport. Es un símbolo unificador del compromiso, la pasión y el deporte, y este buzo con capucha adidas lo luce con orgullo en el pecho. Ponte el tuyo y únete a la comunidad global.</p>
					...
					<div class="clearfix"> </div>
					<div class="quantity">
						<p class="Cantidad"> Cantidad :  </p><input min="1" type="number" value="1" class="item_quantity">
					</div>
					<div class="btn_form">
...
">
	...
	<script type="text/javascript">
		var sound = new Audio();
		sound.src = "../images/Audio/Single.mp3"
	</script>
	<!--//search jQuery-->
