<!--https://www.iloveimg.com/ Primero redimensionar tamaño de imagen a 219x291 px 
https://www.remove.bg remover fondo
 -->
<!DOCTYPE html>
<html lang = "es">
<head>
...
<script src ="./application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false);
						...
						<ul class="slides">
							<li>
								...
								<div class="col-md-7 trend-right">
									<h4>DESCUENTOS EN ACCESORIOS DEPORTIVOS</h4>
							...
							<li>
								...
								<div class="col-md-7 trend-right">
									<h4>DESCUENTOS EN CONJUNTOS FEMENINOS</h4>
									<h5>20% DE DESCUENTO</h5>
